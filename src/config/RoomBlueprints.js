const RoomBlueprints = {
    ...
    4: [
        ...
        { structureType: STRUCTURE_EXTENSION, x: 23, y: 25 },
        { structureType: STRUCTURE_EXTENSION, x: 27, y: 25 },
        { structureType: STRUCTURE_EXTENSION, x: 24, y: 27 },
        { structureType: STRUCTURE_EXTENSION, x: 26, y: 27 },
    ...
    5: [
        ...
        { structureType: STRUCTURE_EXTENSION, x: 22, y: 24 },
        { structureType: STRUCTURE_EXTENSION, x: 28, y: 24 },
        { structureType: STRUCTURE_EXTENSION, x: 22, y: 26 },
        { structureType: STRUCTURE_EXTENSION, x: 28, y: 26 },
    ...
    6: [
        ...
        { structureType: STRUCTURE_EXTENSION, x: 29, y: 23 },
        { structureType: STRUCTURE_EXTENSION, x: 21, y: 27 },
        { structureType: STRUCTURE_EXTENSION, x: 29, y: 27 },
        { structureType: STRUCTURE_EXTENSION, x: 23, y: 21 },
    ...
    7: [
        ...
        { structureType: STRUCTURE_EXTENSION, x: 25, y: 21 },
        { structureType: STRUCTURE_EXTENSION, x: 25, y: 29 },
        { structureType: STRUCTURE_EXTENSION, x: 22, y: 21 },
        { structureType: STRUCTURE_EXTENSION, x: 28, y: 21 },
        { structureType: STRUCTURE_EXTENSION, x: 22, y: 29 },
    ...
    8: [
        ...
        { structureType: STRUCTURE_EXTENSION, x: 21, y: 22 },
        { structureType: STRUCTURE_EXTENSION, x: 29, y: 22 },
        { structureType: STRUCTURE_EXTENSION, x: 21, y: 28 },
        { structureType: STRUCTURE_EXTENSION, x: 29, y: 28 },
        { structureType: STRUCTURE_EXTENSION, x: 23, y: 22 },
